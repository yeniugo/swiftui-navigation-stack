...
public struct PushView<Label, Destination, Tag>: View where Label: View, Destination: View, Tag: Hashable {
    ...
    private func push() {
        navigationStack.push(destination, withId: destinationId, Animate: needAnimate)
    }
}
